// Auto-migrated from the former prose list in publications.mdx.
// Single source of truth for publications across the site: the /publications
// page renders this list, and each person's Publications section is generated
// from it by author matching (see src/utils/authorMatch.ts).
...
export interface Publication {
  ...
  body: string;
  /** Visible text of the trailing link (e.g. a DOI). */
  linkText: string;
  url: string;
}
